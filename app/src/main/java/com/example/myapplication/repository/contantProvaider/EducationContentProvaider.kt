package com.example.myapplication.repository.contantProvaider
...
import com.example.myapplication.room.CITY
import com.example.myapplication.room.HistoryDao
import com.example.myapplication.room.HistoryEntity
import com.example.myapplication.room.ID
import com.example.myapplication.room.TEMPERATURE
...
private const val URI_ALL = 1 // URI для всех записей
    ...
    class EducationContentProvider : ContentProvider() {
        ...
        override fun onCreate(): Boolean {
            ...
            authorities = context?.resources?.getString(R.string.reload)
